/* 
    given two arrays (members, expense) are final results of entire trip
    both have equal indexes and indexes represents who spends how much.
    below function (settlePayment) takes two parameters and return a array for relavant member with money to be paid to the member
*/
...
function settlePayment(members,expense) {
    ...
    while(payementIsNowSettled === false) {
        ...
        */
        ...
        let otherThanZero = expense.findIndex(ele => ele > 10)
        if(otherThanZero === -1){
...
console.log(settlePayment(members,expense));
